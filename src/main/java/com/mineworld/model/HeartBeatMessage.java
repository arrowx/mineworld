...
public class HeartBeatMessage extends BaseMessage {
    ...
    public static final HeartBeatMessage instance = new HeartBeatMessage(null, CON_TYPE);
    
    /**
     * @param b
     * @param t
     */
    private HeartBeatMessage(byte[] b, int t) {
        super(b, t);
    }
    ...
    @Override
    public byte getType() {
        return Constant.MSG_TYPE_HEART_BEAT;
    }
