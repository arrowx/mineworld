 ...
 */
public class RestartReply extends BaseMessage {
    
    public static final RestartReply instance = new RestartReply(null, CON_TYPE);
    
    /**
     * @param b
     * @param t
     */
    private RestartReply(byte[] b, int t) {
        super(b, t);
    }
    ...
    @Override
    public byte getType() {
        return Constant.MSG_TYPE_RESTART_REPLY;
    }
