 ...
 */
public class MongoUpgradeZll /*extends BaseMongoEntity*/ {
    /*
    *//***//*
    private static final long serialVersionUID = 8244069641226805193L;
    
    *//***//*
    public static final String COLLECTION_NAME = "UpgradeZll";
    ...
    *//**
     * 
     *//*
    public MongoUpgradeZll(String u, byte[] v) {
        super();
        this.setU(u);
        this.setV(v);
    }
