 ...
 */
public class UpgradeAcsMessage extends BaseMessage {
     ...
     * @param t
     */
    public UpgradeAcsMessage(byte[] b) {
        this(b, 0);
     ...
     * @param t
     */
    public UpgradeAcsMessage(byte[] v, short s, String md5, String uri) {
     ...
     * @param t
     */
    private UpgradeAcsMessage(byte[] b, int t) {
        super(b, t);
    }
    ...
    @Override
    public byte getType() {
        return Constant.MSG_TYPE_UPGRADE_ACS;
    }
